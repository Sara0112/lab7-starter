...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		this.shadow.appendChild(recipeCardStyle);
		this.shadow.appendChild(recipeCardArticle);
	...
	set data(data) {
		...
		let recipeCardArticle = this.shadow.querySelector('article');
